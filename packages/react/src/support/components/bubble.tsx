...
export const Bubble: React.FC<BubbleProps> = ({ className }) => {
  return (
    <Primitive.Bubble
      className={cn(
        "relative flex h-12 w-12 cursor-pointer items-center justify-center rounded-full bg-co-background-400 text-co-primary transition-colors hover:bg-co-background-400 data-[open=true]:bg-co-background-500",
        className
      )}
    >
