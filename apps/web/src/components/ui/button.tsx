...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-3 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive hover:cursor-pointer",
  {
    variants: {
      variant: {
        default: cn(
          // Bg
          "text-primary-foreground bg-gradient-to-b from-[#323232] to-[#222222] hover:from-[#3E3E3E] hover:to-[#222222] active:from-[#222222] active:to-[#323232]",
        ...
        secondary: cn(
          // Bg
          "text-primary bg-gradient-to-b from-[#E5E5E5] to-[#E2E2E2] hover:from-[#F1F1F1] hover:to-[#F2F2F2] active:from-[#E2E2E2] active:to-[#E5E5E5]",
          // Btn textures on light mode
