...
export const Icon: React.FC<IconProps> = ({
  ...
  return (
    <svg
      ...
      className={cn(size, "text-primary", className)}
    >
      {iconType === "filled" ? (
        <path
          fillRule="evenodd"
...
// Export individual icon components for convenience (optional)
export const SidebarIcon: React.FC<Omit<IconProps, "name">> = (props) => (
