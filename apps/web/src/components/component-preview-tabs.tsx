      ...
      <div className="relative rounded bg-background">
        {withOrnament && (
          <>
            ...
            <div className="-top-[25vh] pointer-events-none absolute left-0 h-[100vh] w-[1px] border-primary/20 border-l border-dashed" />
            <div className="-top-[25vh] pointer-events-none absolute left-4 h-[100vh] w-[1px] border-primary/20 border-l border-dashed" />
            ...
            <div className="-top-[25vh] pointer-events-none absolute right-0 h-[100vh] w-[1px] border-primary/20 border-r border-dashed" />
            <div className="-top-[25vh] pointer-events-none absolute right-4 h-[100vh] w-[1px] border-primary/20 border-r border-dashed" />
            ...
            <div className="-left-[100vw] -right-6 pointer-events-none absolute top-0 h-[1px] w-[300vw] border-primary/20 border-t border-dashed" />
            <div className="-left-[100vw] -right-6 pointer-events-none absolute top-4 h-[1px] w-[300vw] border-primary/20 border-t border-dashed" />
            ...
            <div className="-left-[100vw] -right-6 pointer-events-none absolute bottom-0 h-[1px] w-[300vw] border-primary/20 border-b border-dashed" />
            <div className="-left-[100vw] -right-6 pointer-events-none absolute bottom-4 h-[1px] w-[300vw] border-primary/20 border-b border-dashed" />
          </>
        )}
        {tab === "preview" && (
          <div
